...
//        BoundedQueue queue = new BoundedQueueV6_1(2); // BlockingQueue 사용
//        BoundedQueue queue = new BoundedQueueV6_2(2); // BlockingQueue 사용
//        BoundedQueue queue = new BoundedQueueV6_3(2); // BlockingQueue 사용
        BoundedQueue queue = new BoundedQueueV6_4(2); // BlockingQueue 사용
